...
{
    utils.getJSON('https://mcatrade.org/api/v1/public/getmarkets', (status, data) => {
        ...
        for (let i=0; i<data.result.length; i++)
        {
            ...
            const LUX = data.result[i].BaseCurrency;
            
            utils.getJSON('https://mcatrade.org/api/v1/public/getmarketsummary?market='+LUX+'-'+BTC+'&period=24', (status2, data2) => {
