...
//        "<p>Registration code is valid for 1 hour</p>" +
        ...
        "<p>Welcome to MCATrade!</br></br>Best Regards,<br>MCATrade Team";
    
    try
    {
        let isSent = false;
        sendmail({
            from: 'MCATrade Mailer <'+g_constants.NOREPLY_EMAIL+'>',
...
exports.SendPasswordResetConfirmation = function(email, user, url, urlCheck, callback)
{
    ...
    const body = 
        ...
        "<p>Someone requested that the password for your MCATrade account be reset</p>" +
        "<p>"+confirmHREF+"</p>" +
        ...
        "<p>This is an automated message. Please, do not reply to it.</p>" +
        "</br></br>Best Regards,<br>MCATrade Team";
...
exports.SendWithdrawConfirmation = function(email, user, url, urlCheck, callback)
{
    ...
    const body = 
        "<h3>Hello "+unescape(user)+"</h3>" +
        "<p>Someone requested withdraw from your MCATrade balance</p>" +
        "<p>"+confirmHREF+"</p>" +
