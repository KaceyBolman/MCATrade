...
exports.object = {
    ...
    '_words_' : {
        ...
        'New to MCATrade?' : ['New to MCATrade?', 'Еще не зарегистрированы на MCATrade?'],
        'Sign up now!' : ['Sign up now!', 'Зарегистрироваться сейчас!'],
        'MCATrade - Cryptocurrency Exchange' : ['MCATrade - Cryptocurrency Exchange', 'MCATrade - Биржа криптовалют с открытым кодом']
    }
};
