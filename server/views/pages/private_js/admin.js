    ...
    const body = 
        "<form>" +
            "<div class='form-group'>" +
                ...
                "<input type='text' class='form-control' id='id-delcoin-name' placeholder='LUXCoin'>" +
            "</div>" +
        "</form>";
    ...
    const body = 
        "<form>" +
            "<div class='form-group'>" +
                ...
                "<input type='text' class='form-control' id='id-newcoin-name' placeholder='LUXCoin'>" +
            "</div>" +
            "<div class='form-group'>" +
                "<label class='col-form-label' for='id-newcoin-ticker'>Coin ticker</label>" +
                "<input type='text' class='form-control' id='id-newcoin-ticker' placeholder='LUX'>" +
            "</div>" +
            "<div class='form-group'>" +
                "<label class='col-form-label' for='id-newcoin-icon'>Icon URL</label>" +
                "<input type='text' class='form-control' id='id-newcoin-icon' placeholder='https://raw.githubusercontent.com/mcatrade/luxcore/0.15.0.2hf/src/qt/res/icons/bitcoin.ico'>" +
            "</div>" +
            "<div class='form-group'>" +
